		...
		<div class="flex justify-between h-16">
			...
			<div class="hidden sm:flex sm:items-center sm:ms-6">
				<x-dropdown align="right" width="48">
					<x-slot name="trigger">
						<button
							class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-seance-400 bg-seance-800 hover:text-seance-300 focus:outline-none transition ease-in-out duration-150">
			...
			<div class="-me-2 flex items-center sm:hidden">
				<button @click="open = ! open"
						class="inline-flex items-center justify-center p-2 rounded-md text-seance-500 text-seance-400 hover:bg-seance-900 focus:outline-none focus:bg-seance-900 focus:text-seance-400 transition duration-150 ease-in-out">
	...
	<div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
		...
		<div class="pt-4 pb-1 border-t border-seance-600">
			...
			<div class="mt-3 space-y-1">
				<x-responsive-nav-link :href="route('profile.show-profile-own')">
					{{ __('Profile') }}
				</x-responsive-nav-link>
