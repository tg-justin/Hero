<section>
	...
	<form method="POST" action="{{ request()->routeIs('profile.edit') ? route('profile.update-hero-registration') : route('profile.register-hero') }}" class="mt-6 space-y-6">
		...
		<div>
			<x-input-label for="first_name" class="block text-sm font-medium" :value="__('First/Given Name')"/>
		...
		<div>
			<x-input-label for="last_name" class="block text-sm font-medium" :value="__('Last/Family Name')"/>
		...
		<div>
			<x-input-label for="pronouns" class="block text-sm font-medium" :value="__('Pronouns')"/>
		...
		<div class="space-y-4">
			...
			<div>
				<x-input-label for="phone_number" class="block text-sm font-medium" :value="__('Phone Number (Optional)')"/>
			...
			{{-- Address Input --}}
			<div>
				<x-input-label for="address" class="block text-sm font-medium" :value="__('Address')"/>
			...
			{{-- City Input --}}
			<div>
				<x-input-label for="city" class="block text-sm font-medium" :value="__('City')"/>
			...
			{{-- State Input --}}
			<div>
				<x-input-label for="state" class="block text-sm font-medium" :value="__('State')"/>
			...
			{{-- Zip Code Input --}}
			<div>
				<x-input-label for="zip_code" class="block text-sm font-medium" :value="__('Zip Code')"/>
			...
			<div>
				<x-input-label for="past_volunteer_experience" class="block text-sm font-medium" :value="__('Past Volunteer Experience')"/>
