...
{{-- First Name Field --}}
<div>
	<x-input-label for="first_name" class="required-field" :value="__('First/Given Name (required 1-100 characters)')"/>
...
{{-- Last Name Field --}}
<div>
	<x-input-label for="last_name" class="required-field" :value="__('Last/Family Name (required 1-100 characters)')"/>
...
{{-- Time Zone Selection --}}
<div>
	<x-input-label for="timezone" class="required-field" :value="__('Time Zone')"/>
