        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/75 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    {{-- Name Input --}}
                    <div>
                        <x-input-label for="name" :value="__('Name')" class="block text-sm font-medium text-seance-700 dark:text-seance-700" />
                    ...
                    {{-- Pronouns Input --}}
                    <div>
                        <x-input-label for="pronouns" :value="__('Pronouns')" class="block text-sm font-medium text-seance-700 dark:text-seance-700" />
                        <x-text-input id="pronouns" class="block mt-1 w-full rounded-md border-seance-300 shadow-sm focus:ring-seance-500 focus:border-seance-500" type="text" name="pronouns" :value="old('pronouns')"  autocomplete="pronouns" />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="block mt-1 w-full rounded-md border-seance-300 shadow-sm focus:ring-seance-500 focus:border-seance-500" type="email" name="email" :value="old('email')" required autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="password_confirmation" class="block mt-1 w-full rounded-md border-seance-300 shadow-sm focus:ring-seance-500 focus:border-seance-500" type="password" name="password_confirmation" required autocomplete="new-password" />
