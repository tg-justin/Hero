<div class="grid grid-cols-1 md:grid-cols-1 gap-4">
    <form method="POST" action="{{ $quest ? route('quests.update', $quest->id) : route('quests.store') }}">
        ...
        @endif
        <div>
            <label for="title" class="block text-lg pt-5 font-medium text-gray-700">Title</label>
        ...
        <div>
            <label for="intro_text" class="block text-lg pt-5 font-medium text-gray-700">Introduction</label>
        ...
        <div>
            <label for="accept_text" class="block text-lg pt-5 font-medium text-gray-700">Accept</label>
        ...
        <div>
            <label for="directions_text" class="block text-lg pt-5 font-medium text-gray-700">Directions</label>
        ...
        <div>
            <label for="complete_text" class="block text-lg pt-5 font-medium text-gray-700">Complete Text</label>
        ...
        <div>
            <label for="bonus_xp_text" class="block text-lg pt-5 font-medium text-gray-700">Bonus XP</label>
        ...
        <div>
            <label for="min_level" class="block text-lg pt-5 font-medium text-gray-700">Minimum Level</label>
            <input type="number" name="min_level" id="min_level" class="mt-1 p-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" min="0" value="{{ old('min_level', $quest->min_level ?? '') }}" required>
            @error('min_level')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            <label for="xp" class="block text-lg pt-5 font-medium text-gray-700">XP</label>
        ...
        <div>
            <label for="category_id" class="block text-lg pt-5 font-medium text-gray-700">Category</label>
        ...
        <div>
            <label for="start_date" class="block text-lg pt-5 font-medium text-gray-700">Start Date</label>
        ...
        <div>
            <label for="expires_date" class="block text-lg pt-5 font-medium text-gray-700">Expires Date</label>
