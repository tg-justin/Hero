<x-app-layout>
    ...
    <div class="py-12 bg-cover bg-center"
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div
                class="bg-white/75 overflow-hidden shadow-xl sm:rounded-lg p-6">  {{-- Adjusted background and added padding --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-4">
                        <div
                            class="bg-white p-4 rounded-md shadow-inner">  {{-- Added card effect to summary/description --}}
