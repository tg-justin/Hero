    ...
    <div class="py-12 bg-cover bg-center">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <p><strong>User:</strong> {{ $questLog->user->name }}</p>
                <p><strong>Quest:</strong> {{ $questLog->quest->title }}</p>
                <p><strong>Completed At:</strong> {{ \Carbon\Carbon::parse($questLog->completed_at)->format('d M Y') }}</p>
                <p><strong>Details:</strong> {{ $questLog->details }}</p>
