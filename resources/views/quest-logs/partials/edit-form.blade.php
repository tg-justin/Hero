            ...
            <form action="{{ route('quest-logs.update', $questLog) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="status" id="status" class="form-select w-full">
                        <option value="Accepted" {{ $questLog->status == 'Accepted' ? 'selected' : '' }}>Accepted
                        </option>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="xp_awarded" id="xp_awarded" class="form-input w-full"
                           value="{{ old('xp_awarded', $questLog->xp_awarded) }}" required>
                    @error('xp_awarded')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="xp_bonus" id="xp_bonus" class="form-input w-full"
                           value="{{ old('xp_bonus', $questLog->xp_bonus) }}">
                    @error('xp_bonus')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
